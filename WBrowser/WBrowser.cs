...
namespace WBrowser
{
    public partial class WBrowser : Form
    {
        ...
        string mcx = "http://www.google.com";// string.Empty;
        string mcxmini ="http://www.yahoo.com";// string.Empty;
        public WBrowser()
        {
            InitializeComponent();
...
//visible items
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            homePage = mcx;
            addNewTab();
            getCurrentBrowser().Navigate(mcx);
            browserTabControl.SelectedTab.Text = "MCX";
            
            addNewTab();
            getCurrentBrowser().Navigate(mcxmini);
            browserTabControl.SelectedTab.Text = "MCX MINI";
...
//delete history
        ...
        private void Form1_DocumentCompleted(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            ...
            if (currentBrowser.Url == null) return;
            this.toolStripStatusLabel1.Text = "Done";
        ...
        private void Form1_ProgressChanged(object sender, WebBrowserProgressChangedEventArgs e)
        {
            if (e.CurrentProgress < e.MaximumProgress)
                toolStripProgressBar1.Value=100;//(int)e.CurrentProgress;
